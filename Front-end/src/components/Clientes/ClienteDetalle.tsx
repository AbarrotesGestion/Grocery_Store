  ...
  return (
    <div className="p-6 bg-dark-bg text-gris-calido min-h-screen space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-dark-card border border-dark-border rounded-xl p-6 flex flex-col justify-between space-y-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm text-gris-calido">
              ...
              <tbody className="divide-y divide-dark-border">
                {historialCredito.map((cred) => (
                  <tr key={cred.id} className="hover:bg-dark-bg/40 transition-colors">
