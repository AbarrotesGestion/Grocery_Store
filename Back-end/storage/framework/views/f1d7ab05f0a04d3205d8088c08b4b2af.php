...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?php echo e(route('supplier_debts.create')); ?>" class="btn btn-primary shadow-sm">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="card border-0 shadow-sm p-3 border-start border-warning border-4">
                ...
                <h4 class="fw-bold mb-0 text-warning">$<?php echo e(number_format($debts->where('status', 'pending')->sum('amount'), 2)); ?></h4>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm p-3 border-start border-danger border-4">
                ...
                <h4 class="fw-bold mb-0 text-danger">$<?php echo e(number_format($debts->where('status', 'overdue')->sum('amount'), 2)); ?></h4>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm p-3 border-start border-success border-4">
                ...
                <h4 class="fw-bold mb-0 text-success">$<?php echo e(number_format($debts->where('status', 'paid')->sum('amount'), 2)); ?></h4>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4">
                                <div class="fw-bold text-dark"><?php echo e($debt->supplier->company_name); ?></div>
                                <small class="text-muted"><?php echo e($debt->supplier->contact_name); ?></small>
                            </td>
                            ...
                            <td class="fw-bold text-dark">$<?php echo e(number_format($debt->amount, 2)); ?></td>
                            <td>
                                <?php
                                    $statusClasses = [
                                ...
                                ?>
                                <span class="badge rounded-pill <?php echo e($statusClasses[$debt->status]); ?> bg-opacity-10 px-3">
                                    <?php echo e($label[$debt->status]); ?>

                                </span>
                            </td>
                            <td class="text-end pe-4">
                                <div class="btn-group shadow-sm">
                                    <a href="<?php echo e(route('supplier_debts.show', $debt->id)); ?>" class="btn btn-sm btn-white text-primary"><i class="fas fa-eye"></i></a>
                                    <a href="<?php echo e(route('supplier_debts.edit', $debt->id)); ?>" class="btn btn-sm btn-white text-warning"><i class="fas fa-edit"></i></a>
                                    <form action="<?php echo e(route('supplier_debts.destroy', $debt->id)); ?>" method="POST" class="d-inline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/luis-yahir/laravel/grocery-store/resources/views/supplier_debts/index.blade.php ENDPATH**/ ?>