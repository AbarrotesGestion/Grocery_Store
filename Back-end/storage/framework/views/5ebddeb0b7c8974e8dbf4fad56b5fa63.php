                    ...
                    <ul class="nav nav-pills small fw-bold" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active py-1" id="images-tab" data-bs-toggle="pill" data-bs-target="#images" type="button" role="tab">
                                <i class="fas fa-images me-1"></i> Carrusel (<?php echo e($carouselImages->count()); ?>)
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link py-1" id="videos-tab" data-bs-toggle="pill" data-bs-target="#videos" type="button" role="tab">
                                <i class="fas fa-video me-1"></i> Videos (<?php echo e($heroVideos->count()); ?>)
                            </button>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="tab-pane fade show active" id="images" role="tabpanel">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $carouselImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="ps-4">
                                                <img src="<?php echo e($image->file_path); ?>" class="rounded shadow-sm" style="width: 80px; height: 45px; object-fit: cover;">
                                            </td>
                                            <td class="small text-muted"><?php echo e(basename($image->file_path)); ?></td>
                                            <td class="small"><?php echo e($image->created_at->format('d/m/Y')); ?></td>
                                            <td class="text-end pe-4">
                                                <form action="<?php echo e(route('media.destroy', $image->id)); ?>" method="POST" class="d-inline">
                        ...
                        <div class="tab-pane fade" id="videos" role="tabpanel">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $heroVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="ps-4">
                                            ...
                                            <td class="small text-muted"><?php echo e(basename($video->file_path)); ?></td>
                                            <td>
                                                <span class="badge bg-<?php echo e($video->is_active ? 'success' : 'secondary'); ?> small">
                                                    <?php echo e($video->is_active ? 'Activo' : 'Inactivo'); ?>

                                                </span>
                                            </td>
                                            <td class="text-end pe-4">
                                                <form action="<?php echo e(route('media.destroy', $video->id)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/luis-yahir/laravel/grocery-store/resources/views/media/index.blade.php ENDPATH**/ ?>