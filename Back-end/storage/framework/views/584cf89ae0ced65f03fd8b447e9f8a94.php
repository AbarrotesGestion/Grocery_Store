...
<div class="container-fluid">
    <div class="mb-4">
        <a href="<?php echo e(route('products.index')); ?>" class="text-decoration-none small text-muted">
                ...
                <form action="<?php echo e(route('products.update', $product->id)); ?>" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" class="form-control" rows="2" required><?php echo e($product->description); ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="stock" class="form-control border-start-0 fw-bold" value="<?php echo e($product->stock); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="min_stock" class="form-control border-start-0" value="<?php echo e($product->min_stock ?? 0); ?>" required title="Alerta de bajo stock">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-bold">Precio Compra ($)</label>
                                <input type="number" step="0.01" name="purchase_price" class="form-control" value="<?php echo e($product->purchase_price); ?>" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-bold">Precio Venta ($)</label>
                                <input type="number" step="0.01" name="price" class="form-control fw-bold text-primary" value="<?php echo e($product->price); ?>" required>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/yahir/grocery_store/resources/views/products/edit.blade.php ENDPATH**/ ?>