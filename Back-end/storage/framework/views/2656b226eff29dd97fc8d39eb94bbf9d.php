...
<body>
    ...
    <div id="homeCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <?php if($carouselImages->count() > 1): ?>
            <div class="carousel-indicators">
                <?php $__currentLoopData = $carouselImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" data-bs-target="#homeCarousel" data-bs-slide-to="<?php echo e($index); ?>" class="<?php echo e($index === 0 ? 'active' : ''); ?>"></button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        <?php endif; ?>
    </div>
...
</html><?php /**PATH /home/luis-yahir/laravel/grocery-store/resources/views/welcome.blade.php ENDPATH**/ ?>